...
int gene[14];   // Each bit is either zero or one
long double value;
long double fitness;
```
| Value  | sign |pow(2, -6) | pow(2, -5) | pow(2, -4) | pow(2, -3) | pow(2, -2) | pow(2, -1) |
| :----: |:----:|:---------:|:----------:|:----------:|:----------:|:----------:|:----------:|
| Index  | 0    | 1         | 2          | 3          | 4          | 5          | 6          |

| Value  | pow(2, 0) | pow(2, 1) | pow(2, 2) | pow(2, 3) | pow(2, 4) | pow(2, 5) | pow(2, 6) |
| :----: |:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|:---------:|
